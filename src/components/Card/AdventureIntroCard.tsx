  ...
  return (
    <View style={styles.card}>
      ...
      <Text style={styles.body}>
        The castle keeps its gates shut at dusk. Ledgers are missing, the reliquary is sealed, and
        every courtier whispers a different version of the truth. Your party has one night to find
        the thread that holds the story together.
      </Text>
      ...
      <View style={styles.tipBlock}>
        ...
        <Text style={styles.tipLine}>
          • Actions reveal evidence and may unlock hidden decisions.
        </Text>
