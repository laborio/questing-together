        ...
        <>
          ...
          {hiddenOptionCount > 0 ? (
            <Text style={styles.hiddenText}>
              {hiddenOptionCount} option(s) remain hidden until reactions unlock them.
            </Text>
          ) : (
          ...
          <View style={styles.optionsList}>
            ...
            {Array.from({ length: hiddenOptionCount }).map((_, index) => (
              <View
                key={`hidden-${index}`}
                style={[styles.optionButton, styles.hiddenOptionPlaceholder]}
              >
                <View style={styles.optionHeader}>
          ...
          {resolvedOption ? (
            ...
            <Pressable
              ...
              style={[
                ...
                (!draftOptionId || !canVote) && styles.confirmButtonDisabled,
              ]}
            >
